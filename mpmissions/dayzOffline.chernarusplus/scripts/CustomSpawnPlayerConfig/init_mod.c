#include "$CurrentDir:mpmissions\dayzOffline.chernarusplus\scripts\CustomSpawnPlayerConfig\Script.c"
#include "$CurrentDir:mpmissions\dayzOffline.chernarusplus\scripts\CustomSpawnPlayerConfig\Sets.c"
